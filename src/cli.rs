...
/// Interactive TUI disk cleanup advisor
#[derive(Debug, Parser)]
#[command(name("prune"), version)]
pub struct Cli {
    /// Depth to show
    #[arg(short, long)]
    ...
    /// Run the disk cleanup advisor (macOS only).
    #[arg(short('a'), long)]
    pub advisor: bool,

    /// Shorthand for --format json in advisor mode.
    #[arg(long)]
    pub json: bool,
    ...
    /// Show scan history sparkline.
    #[arg(long)]
    pub history: bool,

    /// Scan for duplicate files and show recommendations.
    #[arg(long)]
    pub duplicates: bool,

    /// Minimum size for duplicate scan (e.g. 10M).
    #[arg(long)]
    pub dup_min_size: Option<String>,

    /// Only show recommendations up to this risk level (safe, low, medium, review).
    #[arg(long)]
    pub risk: Option<String>,

    /// Advisor format: table, json, plain.
    #[arg(long)]
    pub format: Option<String>,

    /// Only show recommendations for this category.
    #[arg(long)]
    pub category: Option<String>,

    /// Exclude dev categories from advisor scan.
    #[arg(long)]
    pub no_dev: bool,

    /// Exclude AI categories from advisor scan.
    #[arg(long)]
    pub no_ai: bool,
}

...
complete -c dust -l dup-min-size -d 'Minimum size for duplicate scan (e.g. 10M)' -r
complete -c dust -l risk -d 'Only show recommendations up to this risk level (safe, low, medium, review)' -r
complete -c dust -l format -d 'Advisor format: table, json, plain' -r
complete -c dust -l category -d 'Only show recommendations for this category' -r
...
complete -c dust -s a -l advisor -d 'Run the disk cleanup advisor (macOS only)'
complete -c dust -l json -d 'Shorthand for --format json in advisor mode'
complete -c dust -s i -l interactive -d 'Launch interactive TUI mode'
complete -c dust -l history -d 'Show scan history sparkline'
complete -c dust -l duplicates -d 'Scan for duplicate files and show recommendations'
complete -c dust -l no-dev -d 'Exclude dev categories from advisor scan'
complete -c dust -l no-ai -d 'Exclude AI categories from advisor scan'
